        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AIChatHistory_Boards_BoardId",
                        column: x => x.BoardId,
                        principalTable: "Boards",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Canvases_Boards_BoardId",
                        column: x => x.BoardId,
                        principalTable: "Boards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Canvases_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Canvases_Users_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CanvasData", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CanvasData_Canvases_CanvasId",
                        column: x => x.CanvasId,
                        principalTable: "Canvases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CanvasData_Users_UpdatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CanvasOperations_Canvases_CanvasId",
                        column: x => x.CanvasId,
                        principalTable: "Canvases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CanvasOperations_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedBoardId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_Boards_RelatedBoardId",
                        column: x => x.RelatedBoardId,
                        principalTable: "Boards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AIChatHistory_BoardId",
                table: "AIChatHistory",
                column: "BoardId");

            migrationBuilder.CreateIndex(
                name: "IX_AIChatHistory_CreatedAt",
                table: "AIChatHistory",
                column: "CreatedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CanvasData_CanvasId",
                table: "CanvasData",
                column: "CanvasId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CanvasData_UpdatedById",
                table: "CanvasData",
                column: "UpdatedById");

            migrationBuilder.CreateIndex(
                name: "IX_Canvases_BoardId",
                table: "Canvases",
                column: "BoardId");

            migrationBuilder.CreateIndex(
                name: "IX_Canvases_CreatedById",
                table: "Canvases",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_Canvases_TeamId",
                table: "Canvases",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "IX_CanvasOperations_CanvasId",
                table: "CanvasOperations",
                column: "CanvasId");

            migrationBuilder.CreateIndex(
                name: "IX_CanvasOperations_UserId",
                table: "CanvasOperations",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_RelatedBoardId",
                table: "Notifications",
                column: "RelatedBoardId");
